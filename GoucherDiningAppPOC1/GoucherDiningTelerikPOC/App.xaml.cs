...
namespace GoucherDiningTelerikPOC
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient("https://goucherdining.azure-mobile.net/", "jSqvirxtzsUxoKjtiznVVOnSyWzpPp73");
        ...
        private async Task<string> getIsOpenResponse(string diningHall)
        {
            ...
            while (menuIndex < menus.Count())
            {
                ...
                if ((DateTime.Now.TimeOfDay > menus[menuIndex].Open) && (DateTime.Now.TimeOfDay < menus[menuIndex].Close)) return diningHall + " is open until " + (menus[menuIndex ].Close.TotalHours % 12) + ".";
                menuIndex++;
            }
